...
export async function POST() {
  try {
    ...
    if (Number(existing.rows[0].cnt) > 0) {
      return NextResponse.json({ ok: true, message: 'Tables exist, data already seeded' });
    }
    ...
    // Seed materials
    const materials = [
      ['فیته دبل 4cm', 'دانه', 25, 380],
      ['فیته نازک 2cm', 'دانه', 104, 180],
      ['دستگیر 15cm بندک‌دار', 'قوتی', 16, 15],
      ['الکوپان طلایی', 'دانه', 12, 190],
      ['میخ یک اینج', 'کارتن', 2, 2400],
      ['دستگیر پلاستیکی', 'کارتن', 6, 750],
      ['کچگ', 'قوتی', 1, 70],
      ['انجامه کلان', 'سیت', 25, 140],
      ['انجامه خورد', 'سیت', 43, 80],
      ['چپ راست چگدار', 'کارتن', 3, 3200],
      ['چپ راست ساده', 'کارتن', 4, 1600],
      ['چپ راست شیشه', 'قوتی', 3, 40],
      ['قلف', 'کارتن', 5, 3700],
      ['خرپیچ 50', 'کارتن', 1.5, 2200],
      ['خرپیچ 32', 'قوتی', 17, 110],
      ['خرپیچ 28', 'قوتی', 5, 110],
      ['خرپیچ 19', 'قوتی', 5, 110],
      ['مرمی استپلر', 'قوتی', 50, 80],
      ['چینل 30', 'دانه', 37, 70],
      ['چینل 32', 'دانه', 44, 70],
      ['چگ بله', 'قوتی', 2, 700],
      ['دستگیر 15cm فولادی', 'قوتی', 14, 11],
      ['دستگیر 25cm طلایی', 'قوتی', 8, 20],
      ['قیتک اتومات', 'پاکت', 15, 650],
      ['لاتو', 'قوتی', 3, 750],
      ['خرپیچ 50 سفید', 'قوتی', 15, 110],
      ['شیرش دلتا آهن', 'کارتن', 10, 3500],
      ['شیرش 20 PVC', 'کارتن', 1, 1600],
      ['چسپ دلتا', 'کارتن', 9, 1600],
      ['کندکسر', 'دانه', 83, 25],
      ['شیرش توفنگچه', 'دانه', 334, 90],
      ['شیرش اسپری', 'کارتن', 19, 3500],
      ['شیرش اسپری دلتا', 'کارتن', 17, 3500],
      ['دیزان سینسی', 'کارتن', 1, 15000]
    ];
    ...
    return NextResponse.json({ ok: true, message: 'Database seeded with 31 products and 34 materials!' });
  } catch (err: any) {
